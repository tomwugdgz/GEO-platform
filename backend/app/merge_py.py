"""
合并 roi_agent_part1.py 和 roi_agent_part2.py 成完整的 roi_agent.py
"""
import os

# 定义文件路径
base_dir = r"d:\Mirofish\AIAdPlacer\backend\app"
output_file = os.path.join(base_dir, "roi_agent.py")
part1_file = os.path.join(base_dir, "roi_agent_part1.py")
part2_file = os.path.join(base_dir, "roi_agent_part2.py")
